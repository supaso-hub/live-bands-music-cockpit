/**
 * store.js
 * Almacén reactivo del estado del presupuesto de Live Bands Music (v.17).
...
const STORAGE_KEY = "LBM_QUOTE_SESSION_V17";
const HISTORY_KEY = "LBM_QUOTES_HISTORY_V17";
  ...
  getHistory() {
    try {
      if (typeof window !== "undefined" && typeof localStorage !== "undefined") {
        const data = localStorage.getItem(HISTORY_KEY) || localStorage.getItem("LBM_QUOTES_HISTORY_V16");
